  ...
  <div :id="pageId" class="relationship-page container-fluid" v-if="isParentPage">
    ...
    <v-modal :show="showSetTutorModal" effect="fade" width="500">
      ...
      <div slot="modal-body" class="modal-body" style="overflow:visible">
        ...
        <div class="form-group">
          <label>员工号</label>
            <detect style="display:inline-block;vertical-align: middle;margin-left: 18px;" ref="searchVal"  url="/api/relClass/getUserSimpleInfo" :searchVal="instructorId.single" keyword="nameOrNo" :placeholder="请输入学工号或者姓名" @afterSelected="afterSelectAddTutor"></detect>
          <!-- <input type="text" class="form-control search-input modal-input" v-model="NewRelationship.instructorId">
    ...
    <v-modal :show="showTutoeBatchTransferModal" effect="fade" width="450">
      ...
      <div slot="modal-body" class="modal-body" style="overflow:visible">
        <div class="transferOut">
          ...
          <div class="form-group">
            <label>员工号</label>
              <detect style="display:inline-block;vertical-align: middle;margin-left: 18px;" ref="searchVal" :searchVal='instructorId.transferOut'  url="/api/relClass/getUserSimpleInfo" keyword="nameOrNo" :placeholder="请输入学号或者姓名" @afterSelected="afterSelectAddTutorOut"></detect>
            <!-- <input type="text" class="form-control modal-input search-input" v-model="NewRelationship.outInstructor">
        ...
        <div class="transferIn">
          ...
          <div class="form-group">
            <label>员工号</label>
             <detect style="display:inline-block;vertical-align: middle;margin-left: 18px;" ref="searchVal" :searchVal='instructorId.transferIn'  url="/api/relClass/getUserSimpleInfo" keyword="nameOrNo" :placeholder="请输入学号或者姓名" @afterSelected="afterSelectAddTutorIn"></detect>
            <!-- <input type="text" class="form-control modal-input search-input" v-model="NewRelationship.inInstructor">
