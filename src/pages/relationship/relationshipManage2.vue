  ...
  <div :id="pageId" class="relationship-page container-fluid" v-if="isParentPage">
    ...
    <v-modal :show="showSetTutorModal" effect="fade" width="500">
      ...
      <div slot="modal-body" class="modal-body" style="overflow:visible">
        ...
        <div class="form-group">
          <label>员工号</label>
           <detect v-if="showSetTutorModal" style="display:inline-block;vertical-align: middle;margin-left: 18px;" ref="searchVal"  url="/api/relClass/getUserSimpleInfo"  keyword="nameOrNo" :placeholder="请输入学工号或者姓名" @afterSelected="afterSelectAddTutor"></detect>
          <!-- <input type="text" class="form-control search-input modal-input" v-model="NewRelationship.instructorId">
    ...
    <v-modal :show="showPluralismModal" effect="fade" width="460">
      ...
      <div slot="modal-footer" class="modal-footer">
        ...
        <button type="button" class="btn submit-btn clearBtnBorder" :class="{disabled: isDisabled.setInstructor}" @click="setPluralismInstructor(isDisabled.setInstructor)">{{translate.submit}}</button>
      </div>
    </v-modal>
    ...
    <v-modal :show="showTutoeBatchTransferModal" effect="fade" width="450">
      ...
      <div slot="modal-body" class="modal-body" style="overflow:visible">
        <div class="transferOut">
          ...
          <div class="form-group">
            <label>员工号</label>
             <detect v-if="showTutoeBatchTransferModal" style="display:inline-block;vertical-align: middle;margin-left: 18px;" ref="searchVal"   url="/api/relClass/getUserSimpleInfo" keyword="nameOrNo" :placeholder="请输入学号或者姓名" @afterSelected="afterSelectAddTutorOut"></detect>
            <!-- <input type="text" class="form-control modal-input search-input" v-model="NewRelationship.outInstructor">
        ...
        <div class="transferIn">
          ...
          <div class="form-group">
            <label>员工号</label>
             <detect v-if="showTutoeBatchTransferModal" style="display:inline-block;vertical-align: middle;margin-left: 18px;" ref="searchVal"   url="/api/relClass/getUserSimpleInfo" keyword="nameOrNo" :placeholder="请输入学号或者姓名" @afterSelected="afterSelectAddTutorIn"></detect>
            <!-- <input type="text" class="form-control modal-input search-input" v-model="NewRelationship.inInstructor">
...
export default {
  ...
  methods: {
    afterSelectAddTutor(o){
      this.instructorId.single = o.userNo;
      this.instructorId.singleName = o.name;
      this.instructorId.singleId = o.userId;
    },
    afterSelectAddTutorOut(o){
      this.instructorId.transferOut = o.userNo
    },
    afterSelectAddTutorIn(o){
      this.instructorId.transferIn = o.userNo
      this.instructorId.transferInUserName = o.name
      this.instructorId.transferInUserId = o.userId
    },
    ...
    setPluralismInstructor: function (isDisabled) {
      if (isDisabled) {
        return false
      }
      sAjax({
        ...
        sAjax({
          ...
          success: (data) => {
            if (data.state) {
              ...
              if (data.code == 50001) {
                if (confirm("该用户不是导师，是否要将其设置为导师？")) {
                  sAjax({
                    url: "/api/tutor/addTutor",
                    dataType: "json",
                    data: {
                      userName: this.instructorId.singleName,
                      userId: this.instructorId.singleId,
                      userNo: this.instructorId.single
                    },
                    type: "post",
                    success: data => {
                      if (data.state) {
                        ...
                        this.$toast(
                          this.translate.submitFailedTip + ":" + data.message
                        );
                      }
                    }
                  });
    ...
    submitTransfer: function (isDisabled) {
        ...
        sAjax({
          ...
          success: (data) => {
            if (data.state) {
              ...
              if (data.code == 50001) {
                if (confirm("转入的用户不是导师，是否要将其设置为导师？")) {
                  sAjax({
                    url: "/api/tutor/addTutor",
                    dataType: "json",
                    data: {
                      userName: this.instructorId.transferInUserName,
                      userId: this.instructorId.transferInUserId,
                      userNo: this.instructorId.transferIn
                    },
                    type: "post",
                    success: data => {
                      if (data.state) {
