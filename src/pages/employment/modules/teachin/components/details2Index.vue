<template>
  <div id="details2Index" :loading='loading'>
    <div class="details2Index col-sm-12">
...
export default {
  ...
  methods: {
    ...
    getDetails() {
      this.loading = true;
      getMeetingInfo2Index(this.props.id).then(data => {
        if (data.state) {
    ...
    back() {
      if (this.props.from == "index") {
        ...
        this.$emit("toSomePage", "/techinList2Index");
      }
    },
    closeDialog() {
...
<style lang="less">
#details2Index .el-form .el-form-item input,
#details2Index .el-form .el-form-item textarea {
