<!--字典管理组件-->
<template>
  <div v-if="curRoute !== 'importPage'" id="dictionary-page" class="container-fluid">
      ...
      <div slot="modal-body" class="modal-body">
        ...
        <div class="modal-body-content">
          ...
          <div v-for="(option,index) in optionsArr" v-dragging="{ item: option, list: optionsArr, group: ' ' }" :key="index">
            <input class="optionInput" type="text" v-model="option.label" @click="editable(option, index)" @change="modifyOption(option,index)" autofocus :readonly="!option.edit" maxlength="20">
            <!-- 选项最右边的icon-->
  ...
  <div id="previewImportPage" v-else>
...
export default {
  ...
  data: function () {
    return {
      ...
      importParams: {
        parentPageTitle: '',
        downloadTemplateUrl: '/system/dict/getImportTemplate',
        downloadErrorTemplateUrl: '/system/dict/getErrorTemplate',
        checkTemplateUrl: '/system/dict/dictTemplate/excel',
        templateName: '批量导入模板',
        importBtnType: [
          {
            url: '/system/dict/batchDictTemplate',
            method: 'get',
            isShowBtn: true,
            name: '批量导入',
            success: data => {
