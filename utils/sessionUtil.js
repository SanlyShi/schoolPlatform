...
exports.getOutLoginCookie = (req, res, schoolId) => {
  return getCookieValue(req, OUTLOGIN_COOKIE_NAME_PREFIX + schoolId);
}
exports.setOutLoginCookie = (req, res, schoolId) => {
  setCookie(res, OUTLOGIN_COOKIE_NAME_PREFIX + schoolId, schoolId, 0);
}
exports.clearOutLoginCookie = (req, res, schoolId) => {
  res.clearCookie(OUTLOGIN_COOKIE_NAME_PREFIX + schoolId);
}

exports.getSignCookie = (req, res) => {
  return getCookieValue(req,'signCookie');
}

exports.setSignCookie = (req, res,signUrl) => {
  setCookie(res, 'signCookie', signUrl, 0);
}

exports.clearSignCookie = (req, res) => {
  res.clearCookie('signCookie');
}
exports.getCaCookie = (req, res) => {
  return getCookieValue(req,'caCookie');
}
exports.getConfigCookie = (req, res) => {
  return getCookieValue(req,'SAAS_S_ID');
}

exports.setCaCookie = (req, res,url) => {
  setCookie(res, 'caCookie', url, 0);
}

exports.clearCaCookie = (req, res) => {
  res.clearCookie('caCookie');
}

exports.getPortrayalCookie = (req, res) => {
  return getCookieValue(req,'portrayal');
}

exports.setPortrayalCookie = (req, res,url) => {
  setCookie(res, 'portrayal', url, 0);
}

exports.clearPortrayalCookie = (req, res) => {
  res.clearCookie('portrayal');
}

exports.getWarningCookie = (req, res) => {
  return getCookieValue(req,'warning');
}

exports.setWarningCookie = (req, res,url) => {
  setCookie(res, 'warning', url, 0);
}

exports.clearWarningCookie = (req, res) => {
...
// 家校通cookie
exports.getFtsCookie = (req, res, schoolId) => {
  return getCookieValue(req, FTS_COOKIE_NAME_PREFIX + schoolId);
}

exports.setFtsCookie = (req, res, schoolId) => {
  setCookie(res, FTS_COOKIE_NAME_PREFIX + schoolId, schoolId, 0);
}

exports.clearFtsCookie = (req, res, schoolId) => {
  res.clearCookie(FTS_COOKIE_NAME_PREFIX + schoolId);
}
//存储学校id的cookie
